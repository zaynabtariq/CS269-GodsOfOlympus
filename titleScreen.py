...
class titleScreen():
    ...
    def createAllButtons(self):
        ...
        all_managers = []
        for i in range(0, 5):
            manager = pygame_gui.UIManager((self.x, self.y), 'button.json')   # Where x and y are background dimensions
    ...
    def initializeTitleScreen(self):
        ...
        background.blit(fighter_1_art, (-100, self.y / 5 + 70))     # Adding 50 to land on cloud, can be removed if want to add platform
